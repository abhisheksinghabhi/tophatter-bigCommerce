...
$tophatterOrderItemsRefundItems = \yii\helpers\Url::toRoute(['tophatterorderdetail/refund-items']);

$orderData = json_decode($orderData,true);

$shipmentData = $orderData['order']['orderLines']['orderLine'];
...
?>
<div class="tophatter-order-details-index">
  <form method="post" action="<?= $tophatterOrderItemsRefundItems ?>">
