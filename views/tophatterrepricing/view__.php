...
$buyBoxReport = TophatterRepricing::readBuyboxCsv($csvFilePath);
?>

<div class="content-section">
    <div class="form new-section">
    	<form method="post" action="<?= Data::getUrl('tophatterrepricing/save') ?>" name="">
...
<?php 		$products = TophatterProduct::getProductInfo(implode(',', $productIds));
			if($products)
			{
				$key = 0;
...
<?php
					...
					{
						$variants = TophatterProduct::getVariantsProductInfo($product['product_id']);
						if($variants)
						{
							$k = 0;
										...
										<table class="table table-striped table-bordered" cellspacing="0">
											<thead>
												<tr>
													<th>TITLE</th>
													<th>SKU</th>
													<th>STATUS ON TOPHATTER</th>
													<!-- <th>QUANTITY</th> -->
													<th>YOUR PRICE</th>
													<th>BEST PRICE ON TOPHATTER</th>
												</tr>
											</thead>
											<tbody>
												<tr>
