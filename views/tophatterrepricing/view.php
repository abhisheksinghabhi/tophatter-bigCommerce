...
$this->title = 'Tophatter Repricing Section';
?>

<div class="content-section">
    <div class="form new-section">
    	<form method="post" id= "repricing_form" action="<?= Data::getUrl('tophatterrepricing/save') ?>" name="">
		    <div class="jet-pages-heading">
		        <div class="title-need-help">
		            <h1 class="Jet_Products_style"><?= Html::encode($this->title) ?></h1>
		            <!-- <a class="help_jet" target="_blank" href="https://shopify.cedcommerce.com/integration/tophatter-marketplace/sell-on-tophatter" title="Need Help"></a> -->
		        </div>
		        <div class="product-upload-menu">
			        	<!-- <button type="button" id="instant-help" class="btn btn-primary">Help</button> -->
			        	<a href="<?= Data::getUrl('tophatterrepricing/index');?>">
			...
			$products = TophatterProduct::getProductInfo(implode(',', $productIds));
			...
			if($products)
			{
				...
				<?php
						$variants = TophatterProduct::getVariantsProduct($product['option_id']);
						if($variants)
						{
							$k = 0;
									...
									<div class="row prod<?=$key?>" style="display: none">
													...
													<div class="left_boxinfo">
														    ...
														    <?php
														    	break;} 	}
												   					...
												   					echo "<b>This Product(Sku) not Found/Uploaded to Tophatter.</b>";
												   				} 
												   			?>
														    </div>
													</div>
										...
										<div class="col-md-6">
												...
												<div class="grey-bg updated-price-section">
													<div class="entry-edit-head">
														<h4 class="">Last 3 updated price on Tophatter</h4>
													</div>
													<div class="row">
...
<link rel="stylesheet" href="<?= Yii::$app->getUrlManager()->getBaseUrl();?>/frontend/modules/tophatter/assets/css/faqstyle.css"> <!-- Resource style -->
