...
$urlManageProduct = \yii\helpers\Url::toRoute(['tophatterproduct/index']);
$validation = new TophatterDataValidation;
?>
      ...
      <?php foreach($data as $productId => $product):?>
          <div class="cards">
            <div class="pro-info">
              ...
              <span class="info"><a target="_blank" href="<?=$urlManageProduct?>?TophatterProductSearch[product_id]=<?=$productId;?>&_edt=<?=$productId;?>"><?=$product ['display_name'];?></a></span>
