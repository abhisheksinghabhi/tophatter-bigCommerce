...
$fname = isset($session['shop_details']['first_name'])?$session['shop_details']['first_name']:'';
$lname =  isset($session['shop_details']['last_name'])?$session['shop_details']['last_name']:'';

$model->name=addslashes($fname).' '.addslashes($lname);

$model->mobile = isset($session['shop_details']['phone'])?$session['shop_details']['phone']:'';
$model->email = isset($session['shop_details']['admin_email'])?$session['shop_details']['admin_email']:'';
$companyname=preg_replace('/[^A-Za-z0-9\-]/', '', $session['shop_details']['name']);
$model->legal_company_name=isset($session['shop_details']['name'])?$companyname:'';

$store_name=preg_replace('/[^A-Za-z0-9\-]/', '', Yii::$app->user->identity->shop_name);
    ...
    <div class="content-section">
        <div class="">
            ...
            <?php $form = ActiveForm::begin(['id'=> 'tophatterregistration-form',/*'enableAjaxValidation' => true, */'enableClientValidation' => true]); ?>
               <?= $form->field($model, 'name', ['options'=>[],'inputOptions'=>['placeholder'=>'Enter Your  Name', 'class'=>'form-control']]) ?>
             ...
             <!--  -->
               ...
               <?= $form->field($model, 'selling_on_tophatter', ['options'=>[]])->dropDownList(['yes'=>'Yes','no'=>'No'],['prompt'=>'Choose...'])->label('Are you already selling on tophatter Marketplace?'); ?> 
               ...
               <div class="required">
                    ...
                    <div class="terms-n-condition">   
                         <strong>CedCommerce Terms & Conditions and Privacy Policy (TOPHATTER Bigcommerce)</strong><br><br>
                         <p>
                         ...
                         For users subscribed under Free Subscription Plan if they choose to unsubscribe before or after the subscription end without subscribing to the Paid Plans then any Product which got published on tophatter Marketplace through tophatter Integration App would get retired from tophatter and would not be available for purchase at tophatter Marketplace through us and functionalities of our app will be disabled for that users as soon as the Free Subscription Plan Expires. <br><br>
                         ...
                         norms.<br><br>
                         In case any partial or complete refund is made to any users then his account would be completely removed from our records. No support would be provided to the item that got published on tophatter Marketplace through our app thereafter as well as such  product on tophatter will be recalled/retired from tophatter Marketplace<br><br>
