...
use frontend\modules\tophatter\controllers\TophatterproductimportController;
...
$urlTotal = Data::getUrl('tophatterproductimport/gettotaldetails');
$varUrl = yii::$app->request->baseUrl.'/var/importproduct/'.$merchant_id.'/';
$url = Data::getUrl('tophatterproductimport/batchimport');
$viewUrl = Data::getUrl('tophatterproductimport/viewerroredproduct');
$file_exist = Data::getUrl('tophatterproductimport/fileexist');
//$iframe_view = Data::getUrl('tophatterproductimport/iframeview');
$file_content = Data::getUrl('tophatterproductimport/getfilecontent');
...
function uploaddata(){
    ...
    function startCustomProductImport(element,page=0)
    {
    	...
    	if(selectCount)
    	{
    		...
    		var max = <?= TophatterproductimportController::MAX_CUSTOM_PRODUCT_IMPORT_PER_REQUEST ?>;
    ...
    function sendCustomImportAjax(productIds, page)
    {
    	...
    	var url = "<?= Data::getUrl('tophatterproductimport/custom-import') ?>";
		$.ajax({
	      method: "post",
	      url: url,
	      dataType: 'json',
