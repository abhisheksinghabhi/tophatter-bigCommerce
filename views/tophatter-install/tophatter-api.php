...
$url = Data::getUrl('tophatter-api/save');
	...
	<div class="api_field fieldset enable_api">
		...
		<ul class="table table-sliiped" cellspacing="0">
			<li>
				<div>
					<div class="value_label">
						<span class="control-label">Tophatter Consumer Id</span>
					</div>
					<div class="form-group required">
						...
						<div class="has-error">
							<p class="help-block help-block-error error_category_map" style="display: none;">'Tophatter Consumer Id' is Required</p>
						</div>
					</div>
					<div class="clear"></div>
				</div>
			...
			<li>
				<div>
					<div class="value_label">
						<span class="control-label">Tophatter Secret Key</span>
					</div>
					<div class="form-group required">
						<textarea placeholder="Please enter Tophatter Secret Key" autofocus="autofocus" id="api-secret_key" class="form-control" name="secret_key"></textarea>
						<div class="has-error">
							<p class="help-block help-block-error error_category_map" style="display: none;">'Tophatter Secret Key' is Required</p>
						</div>
					</div>
					<div class="clear"></div>
				</div>
			...
			<!-- <li>
				<div>
					<div class="value_label">
						<span class="control-label">Tophatter Consumer Channel Type ID</span>
					</div>
					<div class="form-group required">
						...
						<div class="has-error">
							<p class="help-block help-block-error error_category_map" style="display: none;">'Tophatter Consumer Channel Type ID' is Required</p>
						</div>
					</div>
					<div class="clear"></div>
				</div>
