...
/* @var $searchModel frontend\modules\tophatter\models\tophatterProductFeedSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Manage Feed Details';
$this->params['breadcrumbs'][] = $this->title;

$viewurl = \yii\helpers\Url::toRoute(['tophatterproductfeed/viewfeed']);

$url = \yii\helpers\Url::toRoute(['tophatterproductfeed/feeddetail']);
$link = \yii\helpers\Url::toRoute(['tophatterproductfeed/file']);

?>
<?= Html::beginForm(['tophatterproductfeed/bulkfeedstatus'], 'post',['id'=>'tophatter_feed']);//Html::beginForm(['tophatterproduct/bulk'],'post');  ?>
<style>
/*.ced-survey {
