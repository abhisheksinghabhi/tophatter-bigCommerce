<?php
use frontend\integration\models\TophatterConfiguration;
use yii\helpers\Html;
use yii\widgets\ActiveForm;
use frontend\modules\tophatter\components\Data;

$this->title = 'Tophatter Configurations';
$this->params['breadcrumbs'][] = $this->title;
$isPrice=false;
$priceType = "";
$priceValue = "";
$priceValueType = "";
$query = "SELECT * FROM `tophatter_email_template` where show_on_admin_setting=1";
...
<div class="jet-configuration-index content-section">
   ...
   <?php $form = ActiveForm::begin([
	    'id' => 'tophatter_config',
	    'action' => \yii\helpers\Url::toRoute(['tophatterconfiguration/index']),
		'method'=>'post',
	    'options' => ['name'=>'tophatter_configupdate'],
	])?>
      ...
      <div class="jet-pages-heading">
        <div class="title-need-help">
            ...
            <a class="help_jet" target="_blank" href="https://bigcommerce.cedcommerce.com/integration/tophatter-marketplace/sell-on-tophatter"
               title="Need Help"></a>
        </div>
    	...
    	<div class="ced-entry-heading-wrapper">
    		<div class="entry-edit-head">
				<h4 class="fieldset-legend">Tophatter Setting</h4>
			</div>
				...
				<table class="table table-striped table-bordered" cellspacing="0">
	                <tbody>
		                <tr>
		                    ...
		                    <td>
		                    	<span><input id="consumer_id" type="text" name="consumer_id" value="<?=$clientData['consumer_id'];?>" class="form-control"></span>
		                    </td>
	                    </tr>
	                    <tr>
		                    <td class="value_label">
		                    ...
		                    <td>
		                    	<span><textarea rows="4" cols="50" id="secret_key" name="secret_key"><?= $clientData['secret_key']; ?></textarea></span>
		                    </td>
	                    </tr>
    	...
    	<div class="ced-entry-heading-wrapper">
    		<div class="entry-edit-head">
	    		<h4 class="fieldset-legend">Tophatter Return Location</h4>
	    	</div>
	    	<div class="fieldset tophatter-configuration-index">
	    		<table class="table table-striped table-bordered" id="return-location-section" cellspacing="0">
	                <tbody>
	                    ...
	                    <tr>
		                    ...
		                    <td>
		                    	<span><input type="text" id="skype_id" name="skype_id" value="<?= $clientData['skype_id'] ?>" class="form-control"></span>
		                    </td>
	                    </tr>
	                </tbody>
                </table>
    	        ...
    	        <div class="ced-entry-heading-wrapper">
            <div class="entry-edit-head">
                <h4 class="fieldset-legend">Tophatter Order</h4>
            </div>
            <div class="fieldset tophatter-configuration-index">
                <table class="table table-striped table-bordered" id="return-location-section" cellspacing="0">
                    <tbody>
                    <tr>
                        <td class="value_label">
                            ...
                            <span class="text-validator">Set 'No' if you don't want to sync order(s) in Bigcommerce store.</span>
                        </td>
                        <td>
                            <span>
        ...
        <div class="ced-entry-heading-wrapper">
            ...
            <div class="fieldset tophatter-configuration-index" id="product-sync-setting">
                <table class="table table-striped table-bordered" cellspacing="0">
                    <tbody>
                    <tr>
                        <td class="value_label">
		...
		<div class="ced-entry-heading-wrapper">
            ...
            <div class="fieldset tophatter-configuration-index" id="product-setting">
                <table class="table table-striped table-bordered" cellspacing="0">
                    <tbody>
                    <tr>
                        <td class="value_label">
                            ...
                            <span class="text-validator">To get product tax code <a
                                        href="<?= Data::getUrl('tophattertaxcodes/index') ?>"
                    ...
                    <tr>
                        <td class="value_label">
                            ...
                            <span class="text-validator">Enter the MINIMUM stock of products (in numeric) below which inventory status is sent as Out-Of-Stock to Tophatter.</span>
                        </td>
                        <td>
                                <span>
                     ...
                     <tr>
                        <td class="value_label">
                            ...
                            <span class="text-validator">select 'yes' if you want to add sale price!!</span>
                        </td>
                        <td>
                                <span>
                                    <select name="sale_price" class="form-control">
                                        <option value="0">No</option>
                                        <option value="1" <?php if (isset($clientData['sale_price']) && $clientData['sale_price']) {
                                            echo "selected=selected";
                                        } ?>>Yes</option>
                                    </select>
                                </span>
                    ...
                    <tr>
                        <td class="value_label">
                            <span>Upload Product Without Quantity</span>
                            <span class="text-validator">select 'yes' if you want to upload product without Quantity</span>
                        </td>
                        <td>
                                <span>
                                    <select name="upload_product_without_quantity" class="form-control">
                                        <option value="0">No</option>
                                        <option value="1" <?php if (isset($clientData['upload_product_without_quantity']) && $clientData['upload_product_without_quantity']) {
                                            echo "selected=selected";
                                        } ?>>Yes</option>
                                    </select>
                                </span>
...
<script>
	...
	$('#tophatter_config').submit(function( event ) 
	{
    ...
    $('#instant-help').click(function(){
        var configQuicktour = introJs().setOptions({
                ...
                steps: [
                  {
                    element: '#api-section',
                    intro: 'Edit the Tophatter API details.',
                    position: 'bottom'
                  },
                 /* {
                  ...
                  },*/
                  {
                    ...
                    intro: 'Update Tophatter Return Location Address.',
                    position: 'bottom'
                  },
                  {
