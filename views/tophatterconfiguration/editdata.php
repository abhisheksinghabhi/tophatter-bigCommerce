	  ...
	  <div class="modal fade" tabindex="-1" id="myModal" role="dialog" aria-labelledby="myLargeModalLabel">
	    <div class="modal-dialog modal-lg">
                        	   ...
                        	   <tbody>
                        	       <tr>
                        	           ...
                        	           <td style="width: 30%">
                                    		...
                                    		<span class="text-validator">To get product tax code click <a target="_blank" href="<?= yii\helpers\Url::toRoute(['tophattertaxcodes/index']); ?>">here</span>
                                    	</td>
                        	       </tr>
                        	   </tbody>
                        	</table>
          ...
          <?php $form = ActiveForm::begin([
                            ...
                            'action' => frontend\modules\tophatter\components\Data::getUrl('tophatterproduct/updateajaxdesc/?id='.$model->product_id),
                            'method'=>'post',
         ]); ?>
