             ...
             <!--  -->
               ...
               <div class="required">
                    ...
                    <div class="terms-n-condition">   
                         <strong>CedCommerce Terms & Conditions and Privacy Policy (WALMART Bigcommerce)</strong><br><br>
                         <p>
                         ...
                         For users subscribed under Free Subscription Plan if they choose to unsubscribe before or after the subscription end without subscribing to the Paid Plans then any Product which got published on WalMart Marketplace through WalMart Integration App would get retired from WalMart and would not be available for purchase at WalMart Marketplace through us and functionalities of our app will be disabled for that users as soon as the Free Subscription Plan Expires. <br><br>
                         ...
                         norms.<br><br>
                         In case any partial or complete refund is made to any users then his account would be completely removed from our records. No support would be provided to the item that got published on WalMart Marketplace through our app thereafter as well as such  product on WalMart will be recalled/retired from WalMart Marketplace<br><br>
