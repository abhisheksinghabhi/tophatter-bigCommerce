...
//print_r($productArray);die;
                        ...
                        {
                            $Catdata = self::getCategoryArray($productArray['sku'],null,$productArray['category'],$tophatter_attributes,null,$productArray['vendor'],$productArray['type'],$connection,$productArray['common_attributes'],$productArray['product_id']);
                        ...
                        {
                            $upload_category = [];
                            $query = "SELECT `parent_id` FROM `tophatter_category` WHERE `category_id`='".$productArray['category']."' LIMIT 0,1";
