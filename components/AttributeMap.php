...
class AttributeMap extends Component
{
    ...
    public static function getShopifyProductTypes($merchant_id = null)
    {
        ...
        $query = "SELECT `product_type`,`category_id`,`category_path` FROM `tophatter_category_map` WHERE `category_id`!='' AND `merchant_id`=" . $merchant_id;
...
//print_r($requiredsubCategoryAttributes);die;
