...
/**
 * This is the model class for table "tophatter_product_repricing".
 *
 * @property integer $id
 ...
 */
class TophatterProductRepricing extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tophatter_product_repricing';
    }
