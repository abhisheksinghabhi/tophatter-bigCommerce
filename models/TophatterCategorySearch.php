 ...
 */
class TophatterCategorySearch extends TophatterCategory
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['category_id', 'title', 'parent_id', 'attributes', 'attribute_values', 'tophatter_attributes', 'tophatter_attribute_values', 'attributes_order'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'category_id', $this->category_id])
            ...
            ->andFilterWhere(['like', 'tophatter_attributes', $this->tophatter_attributes])
            ->andFilterWhere(['like', 'tophatter_attribute_values', $this->tophatter_attribute_values])
