...
//         }
    ...
    public function actionInventorypost()
    {
        ...
        //echo $index;
       // print_r($session['products_for_inventory_update']);
   ...
   /* public function actionBatchretire()
    ...
    public function actionBatchimportproduct()
    {
        ...
        try
        {
            ...
            $products = $this->bigcom->call('GET', 'catalog/products?include_fields=name,description,sale_price,weight,price,sku,upc,categories,inventory_level,brand_id&include=variants,images&limit=50&page='.$index.'');
